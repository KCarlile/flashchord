...
$(document).ready(() => {
  ...
  $("input[type=radio][name=time_signature]").change(() => {
  ...
  $("#beginner_preset").click(() => {
    $(".difficulty_beginner").each(() => {
      if ($beginner_preset) {
  ...
  $("#intermediate_preset").click(() => {
    $(".difficulty_intermediate").each(() => {
  ...
  $("#advanced_preset").click(() => {
    $(".difficulty_advanced").each(() => {
      if ($advanced_preset) {
        $(this).prop("checked", false);
  ...
  $('input[name="hide_next_chord"]').click(() => {
    $("#next_chord").toggle();
  });

  // hide/show visual metronome
  $('input[name="metronome_visual"]').click(() => {

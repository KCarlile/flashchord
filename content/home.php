...
<button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#flash-chord-settings" aria-controls="flash-chord-settings">Show Settings &amp; Instructions</button>

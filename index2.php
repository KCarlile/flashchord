    ...
    <div class="container">
        ...
        <div class="text-center mt-4">
            <div class="d-inline-block text-left">
                <input type="checkbox" name="metronome-audio" checked />
                <label for="metronome-audio">Metronome audio</label>
                <br />
                <input type="checkbox" name="metronome-visual" checked />
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="custom-control custom-checkbox mt-3">
                            ...
                            <label for="rare-enharmonics" class="custom-control-label">Enable rare enharmonic chords <small>(C♭, B♯, F♭, E♯)</small></label>
                        </div>
                        <div class="custom-control custom-checkbox mt-3">
                            <input type="checkbox" class="custom-control-input" id="slash-chords" name="slash-chords" />
                            <label for="slash-chords" class="custom-control-label">Enable inversions via slash chords <small>(C/E, Am/C, G/B, D/F#, etc.)</small></label>
                        </div>
                        <div class="custom-control custom-checkbox mt-3">
                            <input type="checkbox" class="custom-control-input" id="hide-next-chord" name="hide-next-chord" />
                            <label for="hide-next-chord" class="custom-control-label">Hide next chord</label>
                        </div>
                    </div>
                </div>
            </div>

...
<nav>
    <ul class="nav nav-pills">
        <li class="nav-item"><a href="/" class="nav-link <?php print($page_name == 'home' ? 'active' : ''); ?>" aria-current="page">Practice</a></li>
        <li class="nav-item"><a href="/donate" class="nav-link <?php print($page_name == 'donate' ? 'active' : ''); ?>">Donate</a></li>
        <li class="nav-item"><a href="/help" class="nav-link <?php print($page_name == 'help' ? 'active' : ''); ?>">Help</a></li>
